...
public class PokemonListContainer extends Observable<PokemonListContainerObserver>{
	...
	public void setPokemonSetLevel(int id) {
		this.pokemonSetLevel = id;
	}
	
	public int getPokemonSetLevel() {
		return this.pokemonSetLevel;
	}
	...
	public void updateOnSelected(int i) {
		this.onPokemonGridSelectionChanged(i);
	}
