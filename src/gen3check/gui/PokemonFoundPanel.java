						...
						(changeThread = new Thread() {
							public void run() {
								...
								for (int i = 0; i < pokemonList.size(); i++) {
									...
									Double frame_aux_seconds = frame_aux * 0.0167;
									HiddenPowerRNG hpow = new HiddenPowerRNG(pokemon_aux);
									// Minute: 3584 frames. Second: 
									// Framerate GBA: 59.7275
									
									model.addRow(new Object[]{
											frame_aux,
											//frame_aux_seconds.toString(),
		...
		this.table.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				Pokemon pokemon = new Pokemon(
						c.getPokemonID(), c.getPokemonSetLevel(), new StatPack(pRNG.hp, pRNG.atk, pRNG.def, pRNG.spa, pRNG.spd, pRNG.spe), //Level Hard Set to 5/6
